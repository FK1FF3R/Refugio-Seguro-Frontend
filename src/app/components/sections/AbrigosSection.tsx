...
export const AbrigosSection = ({ data }: { data: Abrigo[] }) => (
  <section id="abrigos" className="w-full py-16 px-4 bg-gray-50">
    <div className="container mx-auto">
      <h2 className="text-4xl font-bold text-center mb-10">Abrigos Disponíveis</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {data.map((abrigo) => (
          <div key={abrigo.id} className="p-6 border rounded-xl shadow-lg bg-white hover:shadow-2xl hover:scale-105 transition-all duration-300">
